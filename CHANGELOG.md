...
- Warranty claim editing with pre-filled form via `PUT /api/warranty-claims/:id` (route: `/warranty-claims/:id/edit`).
- Warranty claim status controls — status dropdown and "Set Pending" button on detail view; status field in edit form.
### Changed
