...
| PDF Services | `backend/src/services/*.ts` | PDF generation for bills, quotations, proforma, inventory reports. Includes configurable footer attribution ("Generated by UHADEV | Custom Business Systems"). |
